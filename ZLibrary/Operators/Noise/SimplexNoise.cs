...
138,236,205,93,222,114,67,29,24,72,243,141,128,195,78,66,215,61,156,180};
        ...
        {
            seedPermutations(seed);
        }

        public virtual void seedPermutations(int seed = 0)
        {
            r = new Random(seed);
            List<int> li = new List<int>(256);
            for (int i = 0; i < 256; i++)
            {
                li.Add(i);
            }
        ...
        public virtual float noise(float xin, float yin, float zin)
        {
        ...
        // 2D simplex noise 
        public virtual float noise(float xin, float yin)
        {
